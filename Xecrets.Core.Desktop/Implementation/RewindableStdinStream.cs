...
internal class RewindableStdinStream : Stream
{
    ...
    /// checkpoint.
    /// </summary>
    private void Rewind() => _position = 0;
    ...
    public override long Seek(long offset, SeekOrigin origin) => _stdin.Seek(offset, origin);

    public override void SetLength(long value) => _stdin.SetLength(value);
