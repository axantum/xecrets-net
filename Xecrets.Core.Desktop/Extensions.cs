...
{
    public static IServiceCollection AddXecretsCoreDesktop(
        this IServiceCollection services,
        string workFolder,
        string settingsFileName,
        string reportFileName,
        long maxReportFileLength)
    {
        Runtime.Register(workFolder, settingsFileName, reportFileName, maxReportFileLength);
