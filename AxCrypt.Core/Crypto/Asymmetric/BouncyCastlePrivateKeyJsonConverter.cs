...
namespace Xecrets.File.Core.Crypto.Asymmetric
{
    internal class BouncyCastlePrivateKeyJsonConverter : JsonConverter<IAsymmetricPrivateKey>
    {
        public override IAsymmetricPrivateKey? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
        {
            ...
            while (reader.Read())
            {
                ...
                {
                    return new BouncyCastlePrivateKey(pem ?? throw new JsonException("'pem' unexpectedly null."));
                }
        ...
        public override void Write(Utf8JsonWriter writer, IAsymmetricPrivateKey value, JsonSerializerOptions options)
        {
            ...
            writer.WriteString("pem", ((BouncyCastlePrivateKey)value).ToString());
