...
namespace Axantum.AxCrypt
{
    public partial class KeyShareDialog : Form
    {
        ...
        public KeyShareDialog(Func<KnownPublicKeys> createKnownPublicKeys)
        {
            ...
            _viewModel = new SharingListViewModel(createKnownPublicKeys);
            ...
            _viewModel.BindPropertyChanged<IEnumerable<EmailAddress>>("KnownKeyShares", (aks) => { _contactsComboBox.Items.Clear(); _contactsComboBox.Items.AddRange(aks.Select(a => a.Address).ToArray()); });
