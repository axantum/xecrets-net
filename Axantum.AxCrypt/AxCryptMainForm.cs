...
namespace Axantum.AxCrypt
{
    ...
    public partial class AxCryptMainForm : Form, ISignIn
    {
        ...
        private void InitializeContentResources()
        {
            ...
            _analysisAxcryptFileToolStripMenuItem.Text = "&" + "[_AnalysisAxcryptFile ]";
        ...
        private void BindToFileOperationViewModel()
        {
            ...
            _analysisAxcryptFileToolStripMenuItem.Click += async (sender, e) => { await _fileOperationViewModel.IntegrityCheckFiles.ExecuteAsync(null); };
