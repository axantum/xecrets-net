...
public class AsciiArmorStream(Stream innerStream) : Stream
{
    ...
    private bool _beginHeaderDone;

    private bool _endFooterDone;
    ...
    private const string Header = "-----BEGIN XECRETS ENCRYPTED-----";

    private const string Footer = "-----END XECRETS ENCRYPTED-----";
    ...
    public override void Write(byte[] buffer, int offset, int count)
    {
        ...
        const int bytesPerLine = MaxLineLength / 4 * 3;
