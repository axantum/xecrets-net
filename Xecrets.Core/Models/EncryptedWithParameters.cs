...
public sealed record EncryptedWithParameters(string Passphrase, IReadOnlyList<PublicKey> Recipients, IReadOnlyList<PublicKey> MasterKeys)
{
    public static EncryptedWithParameters Empty { get; } = new(string.Empty, [], []);
}
