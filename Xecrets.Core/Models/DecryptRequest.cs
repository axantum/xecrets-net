...
/// <summary>
/// The parameters for decryption.
/// </summary>
/// <param name="Identities">The identities to try decryption with.</param>
/// <param name="Progress">Progress is reported here. The implementation is responsible for cancellation, if any.</param>
public sealed record DecryptRequest(IReadOnlyList<Identity> Identities, IProgress<Progress> Progress);
