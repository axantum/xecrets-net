...
namespace Axantum.AxCrypt.Core.Test
{
    ...
    public static class TestV2DocumentHeaders
    {
        ...
        {
            using (V2DocumentHeaders headers = new V2DocumentHeaders(new V2AesCrypto(new GenericPassphrase(new SymmetricKey(256)), new SymmetricIV(128)), 10))
            {
        ...
        {
            using (V2DocumentHeaders headers = new V2DocumentHeaders(new V2AesCrypto(new GenericPassphrase(new SymmetricKey(256)), new SymmetricIV(128)), 20))
            {
                byte[] output;
