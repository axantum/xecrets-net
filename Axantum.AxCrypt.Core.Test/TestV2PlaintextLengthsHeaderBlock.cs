...
{
    [TestFixture]
    public static class TestV2PlaintextLengthsHeaderBlock
    {
        [SetUp]
        ...
        {
            V2PlaintextLengthsHeaderBlock block = new V2PlaintextLengthsHeaderBlock(new V2AesCrypto(new V2Passphrase("secret", 256)));
            V2PlaintextLengthsHeaderBlock clone = (V2PlaintextLengthsHeaderBlock)block.Clone();
