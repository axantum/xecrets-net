    ...
    public static class TestMainViewModel
    {
        ...
        public static void TestDragAndDropFilesPropertyBindSetsDroppableAsRecent()
        {
            using (MainViewModel mvm = Factory.New<MainViewModel>())
            {
                ...
                id = new PassphraseIdentity("Test2", new SymmetricKey(128));
                Instance.FileSystemState.Identities.Add(id);
                Instance.KnownKeys.DefaultEncryptionKey = id.Key;
                mvm.DragAndDropFiles = new string[] { decryptedFilePath, };
        ...
        public static void TestSetRecentFilesComparer()
        {
            ...
            activeFile = new ActiveFile(Factory.New<IRuntimeFileInfo>(file1), Factory.New<IRuntimeFileInfo>(decrypted1), new SymmetricKey(128), ActiveFileStatus.NotDecrypted);
            ...
            activeFile = new ActiveFile(Factory.New<IRuntimeFileInfo>(file2), Factory.New<IRuntimeFileInfo>(decrypted2), new SymmetricKey(128), ActiveFileStatus.NotDecrypted);
            Instance.FileSystemState.Add(activeFile);

            FakeRuntimeEnvironment.Instance.TimeFunction = () => new DateTime(2003, 3, 3);
            FakeRuntimeFileInfo.AddFile(file3, null);
            activeFile = new ActiveFile(Factory.New<IRuntimeFileInfo>(file3), Factory.New<IRuntimeFileInfo>(decrypted3), new SymmetricKey(128), ActiveFileStatus.NotDecrypted);
            Instance.FileSystemState.Add(activeFile);
        ...
        public static void TestOpenFiles()
        {
            ...
            using (MainViewModel mvm = Factory.New<MainViewModel>())
            {
                FakeRuntimeEnvironment.Instance.TimeFunction = () => new DateTime(2001, 1, 1);
                FakeRuntimeFileInfo.AddFile(file1, null);
                activeFile = new ActiveFile(Factory.New<IRuntimeFileInfo>(file1), Factory.New<IRuntimeFileInfo>(decrypted1), new SymmetricKey(128), ActiveFileStatus.AssumedOpenAndDecrypted);
                Instance.FileSystemState.Add(activeFile);
        ...
        public static void TestClearPassphraseMemory()
        {
            ...
            Instance.KnownKeys.Add(new SymmetricKey(128));
            PassphraseIdentity id = new PassphraseIdentity("Test", new SymmetricKey(128));
            Instance.FileSystemState.Identities.Add(id);
            Instance.KnownKeys.DefaultEncryptionKey = id.Key;
        ...
        public static void TestRemoveWatchedFolders()
        {
            ...
            using (MainViewModel mvm = Factory.New<MainViewModel>())
            {
                PassphraseIdentity id = new PassphraseIdentity("Logged On User", new SymmetricKey(128));
        ...
        public static void TestSetDefaultEncryptionKeyWithoutIdentity()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => Instance.KnownKeys.DefaultEncryptionKey = new SymmetricKey(128), "Should fail since there is no matching identity.");
        }
