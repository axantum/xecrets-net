...
namespace Axantum.AxCrypt.Core.Test
{
    ...
    public static class TestV2KeyWrapHeaderBlock
    {
        ...
        public static void TestConstructorFromKeyUsingKeyWrap128TestVectors()
        {
            ...
            V2KeyWrapHeaderBlock header = new V2KeyWrapHeaderBlock(new V2AesCrypto(_keyEncryptingKey128, SymmetricIV.Zero128, 0), 6);
        ...
        public static void TestConstructorFromKeyUsingKeyWrap256TestVectors()
        {
            ...
            V2KeyWrapHeaderBlock header = new V2KeyWrapHeaderBlock(new V2AesCrypto(_keyEncryptingKey256, SymmetricIV.Zero128, 0), 6);
        ...
        public static void TestMasterIVWithWrongKeyEncryptingCrypto()
        {
            ...
            header.Crypto = new V2AesCrypto(new V2Passphrase(new Passphrase("another secret"), 256, CryptoFactory.Aes256Id), SymmetricIV.Zero128, 0);
            SymmetricIV iv = header.MasterIV;
