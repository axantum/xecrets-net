...
namespace Axantum.AxCrypt.Core.Test
{
    ...
    public static class TestV2CompressionEncryptedHeaderBlock
    {
        ...
        public static void TestClone()
        {
            ...
            V2CompressionEncryptedHeaderBlock compressionHeaderBlock = new V2CompressionEncryptedHeaderBlock(new V2AesCrypto(new V2Aes256CryptoFactory(), new GenericPassphrase(SymmetricKey.Zero256), SymmetricIV.Zero128, 0));
