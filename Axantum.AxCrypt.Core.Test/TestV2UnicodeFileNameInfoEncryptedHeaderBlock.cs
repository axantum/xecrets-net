...
namespace Axantum.AxCrypt.Core.Test
{
    ...
    public static class TestV2UnicodeFileNameInfoEncryptedHeaderBlock
    {
        ...
        public static void TestBadDataCausedByBadKeyForExample()
        {
            ...
            headerBlock.HeaderCrypto = new V2AesCrypto(new V2Aes256CryptoFactory(), new V2DerivedKey(new Passphrase("passphrase"), 256, V2Aes256CryptoFactory.CryptoId).DerivedKey, SymmetricIV.Zero128, 0);
            string s;
