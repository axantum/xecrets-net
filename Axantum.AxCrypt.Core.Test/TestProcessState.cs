...
namespace Axantum.AxCrypt.Core.Test
{
    ...
    public static class TestProcessState
    {
        ...
        public static void TestPurgeInactive()
        {
            ...
            ActiveFile activeFile1 = new ActiveFile(Factory.New<IRuntimeFileInfo>(@"C:\encrypted.axx"), Factory.New<IRuntimeFileInfo>(@"C:\decrypted.txt"), new GenericPassphrase("passphrase"), ActiveFileStatus.NotDecrypted, true);
            ...
            ActiveFile activeFile2 = new ActiveFile(Factory.New<IRuntimeFileInfo>(@"C:\encrypted2.axx"), Factory.New<IRuntimeFileInfo>(@"C:\decrypted2.txt"), new GenericPassphrase("passphrase"), ActiveFileStatus.NotDecrypted, true);
