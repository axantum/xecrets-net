...
namespace Axantum.AxCrypt.Core.Test
{
    ...
    public static class TestActiveFileCollectionTests
    {
        ...
        public static void TestActiveFileCollectionEnumerationConstructor()
        {
            ...
            ActiveFile activeFile1 = new ActiveFile(encryptedFileInfo1, decryptedFileInfo1, new GenericPassphrase("newA"), ActiveFileStatus.None, true);
            ActiveFile activeFile2 = new ActiveFile(encryptedFileInfo2, decryptedFileInfo2, new GenericPassphrase("newB"), ActiveFileStatus.None, true);
