    ...
    public static class TestLockingStreamTests
    {
        ...
        public static void TestSimple()
        {
            ...
            using (LockedStream lockedStream = LockedStream.OpenWrite(fileInfo))
            {
                ...
                Assert.That(Task.Run(() => FileLockReleaser.IsLocked(fileInfo)).Result, "The file should be locked now.");
            ...
            Assert.That(!Task.Run(() => FileLockReleaser.IsLocked(fileInfo)).Result, "The file should be unlocked now.");
