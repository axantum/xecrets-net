...
namespace Axantum.AxCrypt.Core.Test
{
    ...
    public static class TestV2PlaintextLengthsEncryptedHeaderBlock
    {
        ...
        {
            V2PlaintextLengthsEncryptedHeaderBlock block = new V2PlaintextLengthsEncryptedHeaderBlock(new V2AesCrypto(new V2Aes256CryptoFactory(), new V2Passphrase(new Passphrase("secret"), 256, CryptoFactory.Aes256Id), SymmetricIV.Zero128, 0));
