...
namespace AxCrypt.Core.Test
{
    ...
    public class TestPasswordStrengthCalculator
    {
        ...
        public void TestPasswordStrengthCalculatorCalibration()
        {
            ...
            Assert.That(estimate, Is.EqualTo(37), "Yutedall");
            estimate = PasswordStrengthCalculator.Estimate("roWinory");
            Assert.That(estimate, Is.EqualTo(37), "roWinory");
            estimate = PasswordStrengthCalculator.Estimate("doDergot");
            Assert.That(estimate, Is.EqualTo(37), "doDergot");
            estimate = PasswordStrengthCalculator.Estimate("feLiedid");
            Assert.That(estimate, Is.EqualTo(37), "feLiedid");
            ...
            Assert.That(estimate, Is.EqualTo(44), "47FIngstsion");
            estimate = PasswordStrengthCalculator.Estimate("Ken3buSlive");
            Assert.That(estimate, Is.EqualTo(50), "Ken3buSlive");
            ...
            Assert.That(estimate, Is.EqualTo(80), "3pglaTere:cHeinst");
            estimate = PasswordStrengthCalculator.Estimate("hYesonse&sKilath9");
            Assert.That(estimate, Is.EqualTo(92), "hYesonse&sKilath9");
            estimate = PasswordStrengthCalculator.Estimate("63Sablerst(aWarlie");
            Assert.That(estimate, Is.EqualTo(80), "63Sablerst(aWarlie");
            ...
            Assert.That(estimate, Is.EqualTo(138), "1005B8C02821440EA36907C7BD21FA1F");
            estimate = PasswordStrengthCalculator.Estimate("AA81862BDE3C48B2BC02517EE678AE2E".ToLower());
            Assert.That(estimate, Is.EqualTo(144), "AA81862BDE3C48B2BC02517EE678AE2E");
            ...
            Assert.That(estimate, Is.EqualTo(324), "8A57C81A1E63478E9E6A0E23004C621B1FA95549A9E840B7BD71C2E01F42EC09");
            estimate = PasswordStrengthCalculator.Estimate("5812FA9880604AEAA929A1FD4B02F86E3D7F45BD0FCB4BA7A227885FBA7A5CB4".ToLower());
            Assert.That(estimate, Is.EqualTo(318), "5812FA9880604AEAA929A1FD4B02F86E3D7F45BD0FCB4BA7A227885FBA7A5CB4");
            estimate = PasswordStrengthCalculator.Estimate("FFA226D1BFDE428BB2B48FFBBF14571C3A19C742AD474320A8BC81E98C083B94".ToLower());
            Assert.That(estimate, Is.EqualTo(312), "FFA226D1BFDE428BB2B48FFBBF14571C3A19C742AD474320A8BC81E98C083B94");
